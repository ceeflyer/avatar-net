...
def _get_filenames(dataset_dir):
    split_dirs = ['train2017', 'val2017', 'test2017']
            ...
            for shard_id in range(_NUM_SHARDS):
                ...
                with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
                    ...
                    for i in range(start_ndx, end_ndx):
                        ...
                        sys.stdout.write('\r>> Converting image {}/{} shard {} name {}'.format(
                            i + 1, len(image_filenames), shard_id, img_filename))
                        sys.stdout.flush()
                        # read the image
                        img_data = tf.gfile.FastGFile(img_filename, 'rb').read()
